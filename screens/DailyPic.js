...
export default class DailyPicScreen extends Component {
    ...
    getAPOD = () => {
        axios
            .get("https://api.nasa.gov/planetary/apod?api_key=YBOKIOG8KtctS3m10a2yWmCk0bVdkCf0kc4vH53s")
            .then(response => {
                    ...
                    <ImageBackground source={require('../assets/stars.gif')} style={styles.backgroundImage}>
                        ...
                        <ScrollView style={styles.listContainer}>
                            <TouchableOpacity
                                onPress={() => Linking.openURL(this.state.apod.url).catch(err => console.error("Couldn't load page", err))}
                            >
                                <Image source={{ "../assets/play-video.png" }} style={{ width: "100%", height: 300, borderRadius: 10 }}></Image>
                            </TouchableOpacity >
